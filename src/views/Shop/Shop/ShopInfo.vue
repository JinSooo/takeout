    ...
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div
            ...
            :key="index"
            :class="discountsTypes[support.type]"
          >
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picWrapperRef">
...
<script lang="ts">
import { defineComponent, inject, nextTick, onMounted, ref, toRef, watch } from 'vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const picWrapperRef = ref()
    /* **************************************************************************************** */
    const _initPicWrapper = () => {
      const liWidth = 120
      const space = 6
      const count = info.value.pics.length

      picWrapperRef.value.style.width = (liWidth + space) * count - space + 'px'
    }

    onMounted(() => {
      if (!info.value.pics) return
      nextTick(() => {
