<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name" @click="showShop = true">{{ info.name }}</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      ...
      <div class="discounts-right" @click="showDiscounts = true">{{ info.supports.length }} 个优惠</div>
    </div>
    <transition name="fade">
      <div class="shop-brief-modal" :key="0" v-if="showShop">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="showShop = false"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-if="showDiscounts">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li
              ...
              :key="index"
              :class="discountsTypes[item.type]"
            >
              <span class="content-tag">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="showDiscounts = false"></span>
          </div>
        </div>
...
export default defineComponent({
  ...
  setup() {
    // 只获取其中的info属性
    const info = toRef(inject('store') as any, 'info')
    // 用于商家优惠信息的type选择
    const discountsTypes = ['activity-green', 'activity-red', 'activity-orange']
    // 显示商家信息
